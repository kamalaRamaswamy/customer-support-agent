...
"""
    try:
        ...
        logger.warning(f"Code Interpreter execution failed: {e}. Fallback calculation applied.")
        tier_rates = {"Silver": 0.00, "Gold": 0.10, "Platinum": 0.15}
...
async def invoke(payload, context=None):
    ...
    try:
        ...
        # Lazy instantiation of Model & Memory Client inside invocation
        ...
        # Async MCP Client initialization with guarded timeout
        if GATEWAY_URL and not GATEWAY_URL.startswith("<"):
            ...
            try:
                ...
                logger.warning(f"MCP Gateway load skipped or timed out: {e}")
        ...
        # Run agent invocation off the main event thread
